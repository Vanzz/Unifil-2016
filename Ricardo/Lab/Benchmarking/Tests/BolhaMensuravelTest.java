...
import Mensuraveis.Ordenacao.BolhaMensuravel;
...
/**
 * The test class BolhaMensuravel.
 *
 * @author  (your name)
 * @version (a version number or a date)
 */
public class BolhaMensuravelTest
{
    @Test
    public void verificaOrdenarBolhaArranjosPequenos() {
    ...
    @Test
    public void verificaBuscaBolhaGrandePar() {
    ...
    @Test
    public void verificaBuscaBolhaGrandeImpar() {
    ...
    private BolhaMensuravel ordenador = new BolhaMensuravel();
}
